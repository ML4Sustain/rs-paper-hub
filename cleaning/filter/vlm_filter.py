...
CORE_KEYWORDS = [
    ...
    r"image[\-\s]to[\-\s]text",
    r"text[\-\s]to[\-\s]image",
    r"(?:image|text|vision|visual|cross[\-\s]modal|sentence|caption).{0,20}\bretrieval\b",
    r"\bretrieval\b.{0,20}(?:image|text|vision|visual|cross[\-\s]modal|sentence|caption)",
    r"cross[\-\s]modal.{0,40}(?:\blanguage\b|\btext\b|\bvision\b|\bvisual\b|\bVLM\b|\bcaption\b|\bretrieval\b)",
    r"(?:\blanguage\b|\btext\b|\bvision\b|\bvisual\b|\bVLM\b|\bcaption\b).{0,40}cross[\-\s]modal",
    r"vision[\-\s]text",
    r"visual[\-\s]text",
    r"image[\-\s]language",
